"""Regression checks for the optiviz casebook."""
...
from casebook.harness import assert_expected, optiviz_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(optiviz_summary(), assert_expected())
