...
`optiviz` is centered on numerical computing work in Julia. The technical target is: Compare descent, momentum, and coordinate search on fixture functions.
...
The score is deterministic. The current threshold is 158. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 2.
