...
optiviz is a Julia project for numerical computing. It focuses on this technical goal: Compare descent, momentum, and coordinate search on fixture functions.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 158, risk penalty 5, latency penalty 4, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
